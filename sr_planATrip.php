...
<html lang="en">
	...
	<head>
		...
		<!-- Linking the Plan a Trip Style file -->
		<link rel="stylesheet" type="text/css" href="../css/sr_planTrip-style.css">
		...
		<!-- Linking the Google API -->
    	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places"></script>

    	<!-- Linking the Plan Trip Script -->
    	<script src="../js/sr_planATrip-script.js"></script>
	...
	<body onload="initialize()">
		...
		<div id="parallax-container">
  			<div class="box box-1 parallax" data-speed-x="200" data-speed-y="200"></div>
  			<div class="box box-2 parallax" data-speed-x="80" data-speed-y="80"></div>

  			<!-- Google Map Displayed -->
  		  <iframe style="overflow:hidden; height: 100%; width: 600px; border: 5px solid #EEE; margin-top: 50px; position: relative;" height="500px" width="500px"
		  ...
		  <div class="container" style=" overflow:hidden;right: 0px; margin-top: -700px; margin-right: -150px; position: relative;">
				    		...
				    		<div class="panel panel-default">
							  	...
							  	<div class="panel-body">
				                    ...
				                    <fieldset>
							    		...
							    		<div class="form-group">
							    			<input id="autocomplete" class="form-control" id="exampleInputName2"  placeholder="Enter the Destination" name="destination" type="text" required></input>
							    		</div>

							    		<div class="form-group">
							    			<input class="form-control" name="date" type=date step=1 min=2014-09-8 required > 
							    		</div>

							    		<div class="form-group">
											<input class="form-control pull-left" name="time" type=time step=900 style="width: 200px;" required>
											<input class= "form-control pull-right" name="seats" type="number" placeholder="#Seats" name="quantity" min="1" max="12" style="width: 100px;" required>
										</div>
	  				...
	  				<div class="form-group">
	    				<label>Source: </label>
	  					<div id="locationField" class = "form-group">
		      				<input id="autocomplete" class="form-control" id="exampleInputName2"  placeholder="Enter the Source" onFocus="geolocate()" type="text"></input>

		      			<label>Destination: </label>
							    <div id="locationField" class = "form-group">
				      				<input id="autocomplete" placeholder="Enter the Destination" onFocus="geolocate()" type="text"></input>
				    			</div>
		    				</div>
	  				</div>
